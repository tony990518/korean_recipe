  ...
  tips: [
    {
      ...
      shortDescription: "一起看看辣椒粉有味道的原因跟解法",
      content: {
        sections: [
          {
            title: "怪味從哪裡來",
            text:
              "多半是保存出問題。放在潮濕或高溫的環境，容易受潮、發霉，還會長細菌，味道就會變得悶悶酸酸的。另外辣椒籽的油脂會氧化（俗稱油耗味），這也是常見的怪味來源。當然，辣椒本身也有自然的辣香，但如果一開罐就刺鼻或像霉味，那就不是正常的香味了。"
          },
          {
            title: "正確保存方式",
            text:
              "裝進可密封的容器，放冷藏或陰涼乾燥的地方最穩。怕受潮可以丟一包乾燥劑（矽膠包）一起放。每次用完記得馬上蓋緊，不要用濕湯匙挖，減少水氣跑進去。"
          },
          {
            title: "去味／補救小撇步",
            text:
              "味道稍微跑掉的辣椒粉，可以用乾鍋小火乾炒 10～20 秒，讓水氣蒸發、香氣回來；但如果有明顯霉味或酸敗味，直接淘汰比較安全。下次購買就挑新鮮度高、顆粒乾爽、聞起來是清爽辣香的就對了。"
          }
        ]
      }
    },
