...
const DB: { recipes: Recipe[]; tips: Tip[] } = {
  recipes: [
    ...
    },
    {
      ...
      steps: [
        { title: "在鍋中加入水 550 ml，並放入泡麵的乾燥蔬菜包以及咖哩塊", text: "在鍋中加入水 550 ml，並放入泡麵的乾燥蔬菜包以及咖哩塊" },
        { text: "加熱慢慢讓咖哩塊溶解，期間輕拌防沾底。", heat: "med", tip: "醬汁略稠、能掛住年糕即好" },
        { text: "水滾後，加入麵以及半包湯包，將麵煮至喜歡的口感。", heat: "med", time: "5 分" },
        { text: "根據個人喜好加入雞蛋、青蔥、辣椒粉等配料，完成！" }
      ],
    },
    {
